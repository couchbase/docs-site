...
def siteS3Bucket = 'docs-staging.couchbase.com'
def infraProfile = 'staging'
...
// Branch specifier: refs/heads/staging
    ...
    success {
      script {
        if (triggerEventType == 'cron') {
          build job: '/Antora/docs-search-indexer/staging', wait: false
        }
      }
