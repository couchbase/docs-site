...
[]
xref:3.1@c-sdk:hello-world:overview.adoc[C SDK 3.1]
...
[]
xref:3.1@php-sdk:hello-world:overview.adoc[PHP SDK 3.1]
...
[]
xref:3.1@python-sdk:hello-world:overview.adoc[Python SDK 3.1]
...
[]
xref:2.8@couchbase-lite::csharp.adoc[Couchbase Lite C# 2.8]
...
[]
xref:2.8@couchbase-lite::java-platform.adoc[Couchbase Lite Java 2.8]
...
[]
xref:2.8@couchbase-lite::java-android.adoc[Couchbase Lite Java Android 2.8]
...
[]
xref:2.8@couchbase-lite::swift.adoc[Couchbase Lite Swift 2.8]
...
[]
xref:2.8@couchbase-lite::objc.adoc[Couchbase Lite Objective-C 2.8]
