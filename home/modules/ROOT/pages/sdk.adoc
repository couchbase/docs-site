= SDKs & Connectors
:page-aliases: 8.0@server:sdk:overview.adoc,7.6@server:sdk:overview.adoc,7.2@server:sdk:overview.adoc,8.0@server:install:install-client-server.adoc,7.6@server:install:install-client-server.adoc,7.2@server:install:install-client-server.adoc
...
xref:enterprise-analytics:intro:intro.adoc[Operational Insights] is an analytical database (RT-OLAP) for real time apps and operational intelligence.
xref:analytics-sdk.adoc[Operational Insights SDKs] are tailored to the APIs offered by this service.

[#table_analytics_sdk,cols="42,40,60,50"]
|===
| Operational Insights SDK | Documentation | Hello World Example | API Reference

| .NET Operational Insights SDK
...
| https://docs.couchbase.com/sdk-api/analytics-dotnet-client[.NET Operational Insights API Reference]

| Go Operational Insights SDK
...
| https://pkg.go.dev/github.com/couchbase/gocbanalytics[Go Operational Insights API Reference]

| Java Operational Insights SDK
...
| https://docs.couchbase.com/sdk-api/couchbase-analytics-java-client[Java Operational Insights API Reference]

| Node.js Operational Insights SDK
...
| https://docs.couchbase.com/sdk-api/analytics-nodejs-client/[Node.js Operational Insights API Reference]

| Python Operational Insights SDK
...
| https://docs.couchbase.com/sdk-api/analytics-python-client/[Python Operational Insights API Reference]
|===
...
== Operational Insights (Capella) SDKs
...
| Couchbase Lite Android (Java and Kotlin)
| xref:couchbase-lite:android:quickstart.adoc[Docs]
| https://docs.couchbase.com/mobile/4.1.0/couchbase-lite-android/[API Reference]

| Couchbase Lite C and {cpp}
| xref:couchbase-lite:c:quickstart.adoc[Docs]
| https://docs.couchbase.com/mobile/4.1.0/couchbase-lite-c[API Reference]

| Couchbase Lite .NET (C#)
| xref:couchbase-lite:csharp:quickstart.adoc[Docs]
| https://docs.couchbase.com/mobile/4.1.0/couchbase-lite-net[API Reference]

| Couchbase Lite Java
| xref:couchbase-lite:java:quickstart.adoc[Docs]
| https://docs.couchbase.com/mobile/4.1.0/couchbase-lite-java/index.html?[API Reference]

| Couchbase Lite JavaScript (Ionic, Flutter, and React Native)
| xref:couchbase-lite::javascript.adoc[Docs]
| 

| Couchbase Lite Swift
| xref:couchbase-lite:swift:quickstart.adoc[Docs]
| https://docs.couchbase.com/mobile/4.1.0/couchbase-lite-swift[API Reference]
|===
