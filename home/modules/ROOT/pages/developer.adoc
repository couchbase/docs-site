...
Develop an app for ia-dev-capella@xref:develop:develop:intro.adoc[Capella Operational],
or a ia-dev-7.6@xref:develop:develop:intro.adoc[self-managed Couchbase Server].
