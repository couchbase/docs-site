...
xref:couchbase-lite::index.adoc[Build your app] for offline-first connectivity, then sync to Couchbase Server with Capella App services (or self-managed Sync Gateway) -- or run peer-to-peer.
