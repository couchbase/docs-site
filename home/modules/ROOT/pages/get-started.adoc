...
* xref:java-sdk:hello-world:start-using-sdk.adoc[Get Started with the Java SDK] -- and our for xref:erver/current/tutorials/couchbase-tutorial-student-records.adoc[NoSQL for RDBMS users] tutorial.
* Try our other SDKs: 
...
Or host your own self-managed xref:#[Couchbase Enterprise Analytics].

xref:columnar-sdk.adoc[Analytics SDKs] are developed from the ground-up and while they maintain some syntactic similarities with the xref:sdk.adoc[operational SDKs],
...
* Sync your data with App Services / self-managed SyncGateway / Edge Server -- or go xref:#[peer-to-peer].
