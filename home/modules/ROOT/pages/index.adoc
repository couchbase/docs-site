...
[.tile]
.Couchbase Mobile
ifdef::site-stage-production[* https://developer.couchbase.com/documentation/mobile/current/couchbase-lite/index.html[Lite]]
ifndef::site-stage-production[* xref:couchbase-lite::index.adoc[Lite]]
