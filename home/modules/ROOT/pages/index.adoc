...
Capella is a Couchbase-managed offering of our operational and analytics databases, App Services to connect edge devices, and AI Services.
...
* Power BI Connector: xref:1.2@power-bi-connector:ROOT:index.adoc[1.2] | xref:1.1@power-bi-connector:ROOT:index.adoc[1.1] | xref:1.0@power-bi-connector:ROOT:index.adoc[1.0]
