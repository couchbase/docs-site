...
====== {empty}
[.content]
_Couchbase is the Developer Data Platform for Critical Applications in Our AI World._
...
== Transactional, analytical, mobile, and AI applications with Couchbase.


[.card-box]
=== icon:rocket[] Transactional Workloads -- in the Cloud or your Datacenter

*Capella Operational* -- Couchbase in the Cloud, managed by us.

xref:[Get Started with Capella Free Tier] |
xref:[Deployment & Admin] |
xref:home:ROOT:sdk.adoc[Developer Docs] |
xref:[Learn -- Concepts & Reference]

Or learn about xref:[Self-managed Couchbase Server], in your datacenter or private cloud.

////
xref:[Sign up for Perpetual Free Tier] |
xref:[Get Started with Capella] |
xref:[Deployment & Admin] |
xref:home:ROOT:sdk.adoc[Developer Docs] |
xref:[Learn -- Concepts & Reference]
...
xref:[Get Started with Couchbase Server] |
...
[.card-box]
=== icon:rocket[] Real Time Analytics with Couchbase Enterprise Analytics

Enterprise Analytics brings the power of NoSQL to the world of analytics.
Columnar storage speeds up querying, enabling real-time use cases for analytical data.

* xref:columnar:intro:intro.adoc[Capella Analytics] brings the power of NoSQL to the world of analytics.
...
Run in your datacenter or private cloud.
