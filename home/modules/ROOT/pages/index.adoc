...
xref:server:getting-started:start-here.adoc[Get Started with Couchbase Server Enterprise]
...
[.column]
.Community Users
* xref:tutorials:getting-started-ce:index.adoc[Get Started with Couchbase Server Community Edition]
