...
This page contains links to End-of-Life, archived documentation, for reference purposes, as well as links to docs for current, GA products. 
Alternatively, return to {primary-site-url}[the main documentation site].
endif::[]
--
...
Capella is a Couchbase-managed offering of our operational and analytics databases, App Services to connect edge devices, and AI Data Plane.
Find current documentation on the https://docs.couchbase.com/home/cloud.html[Capella pages].

[.tiles.browse]
== Couchbase Server & AI Data Plane

[.tile]
.Server
* xref:8.0@server:introduction:whats-new.adoc[Version 8.0]
...
* xref:2.9@operator::whats-new.adoc[Version 2.9]
...
* xref:2.2@enterprise-analytics:intro:intro.adoc[Version 2.2]
* xref:2.1@enterprise-analytics:intro:intro.adoc[Version 2.1]
* xref:2.0@enterprise-analytics:intro:intro.adoc[Version 2.0]

[.tile]
.(Self-Managed) AI Data Plane
* https://pypi.org/project/agentc/1.1.0/[Agent Catalog 1.1]
* https://pypi.org/project/agentc/1.0.0/[Agent Catalog 1.0]
* https://pypi.org/project/couchbase-agent-memory/[Agent Memory 1.0]
* https://pypi.org/project/couchbase-mcp-server/1.0.0/[MCP Server 1.0]
...
[.tile]
.Couchbase Lite
* xref:4.1@couchbase-lite::index.adoc[Version 4.1]
* xref:4.0@couchbase-lite::index.adoc[Version 4.0]
* xref:3.3@couchbase-lite::index.adoc[Version 3.4]
* xref:3.3@couchbase-lite::index.adoc[Version 3.3]
...
* https://cbl-reactnative.dev/[CBL React Native 1.1]
* https://cbl-reactnative.dev/1.0[CBL React Native 1.0]

[.tile]
.Couchbase Sync Gateway
* xref:4.1@sync-gateway::index.adoc[Version 4.1]
* xref:4.0@sync-gateway::index.adoc[Version 4.0]
...
* xref:1.0@couchbase-edge-server:introduction:intro.adoc[Version 1.1]
...
[.tile]
.Java SDK
* xref:3.12@java-sdk:hello-world:start-using-sdk.adoc[Version 3.12]
* xref:3.11@java-sdk:hello-world:start-using-sdk.adoc[Version 3.11]
* xref:3.10@java-sdk:hello-world:start-using-sdk.adoc[Version 3.10]
...
* xref:1.1@quarkus-extension::overview.adoc[Quarkus Java Extension 1.3]
* xref:1.1@quarkus-extension::overview.adoc[Quarkus Java Extension 1.2]
...
[.tile]
.Node.js SDK
* xref:4.7@nodejs-sdk:hello-world:start-using-sdk.adoc[Version 4.7]
* xref:4.6@nodejs-sdk:hello-world:start-using-sdk.adoc[Version 4.6]
...
[.tile]
.{dotnet-attr} SDK
* xref:3.9@dotnet-sdk:hello-world:start-using-sdk.adoc[Version 3.9]
...
[.tile]
.Python SDK
* xref:4.6@python-sdk:hello-world:start-using-sdk.adoc[Version 4.6]
* xref:4.5@python-sdk:hello-world:start-using-sdk.adoc[Version 4.5]
...
[.tile]
.Ruby SDK
* xref:3.8@ruby-sdk:hello-world:start-using-sdk.adoc[Version 3.8]
* xref:3.7@ruby-sdk:hello-world:start-using-sdk.adoc[Version 3.7]
...
[.tile]
.Scala SDK
* xref:3.12@scala-sdk:hello-world:start-using-sdk.adoc[Version 3.12]
* xref:3.11@scala-sdk:hello-world:start-using-sdk.adoc[Version 3.11]
* xref:3.10@scala-sdk:hello-world:start-using-sdk.adoc[Version 3.10]
...
[.tile]
.Kotlin SDK
* xref:3.12@kotlin-sdk:hello-world:overview.adoc[Version 3.12]
* xref:3.11@kotlin-sdk:hello-world:overview.adoc[Version 3.11]
* xref:3.10@kotlin-sdk:hello-world:overview.adoc[Version 3.10]
...
[.tile]
.PHP SDK
* xref:4.5@php-sdk:hello-world:start-using-sdk.adoc[Version 4.5]
* xref:4.4@php-sdk:hello-world:start-using-sdk.adoc[Version 4.4]
...
[.tile]
.Go SDK
* xref:2.12@go-sdk:hello-world:start-using-sdk.adoc[Version 2.12]
...
[.tile]
.{cpp} SDK 
* xref:1.3@cxx-sdk:hello-world:start-using-sdk.adoc[Version 1.3]
* xref:1.2@cxx-sdk:hello-world:start-using-sdk.adoc[Version 1.2]
...
[.tile]
.Rust SDK
* xref:1.0@rust-sdk:hello-world:start-using-sdk.adoc[Version 1.0]
...
[.tile]
.{dotnet-attr} SDK
* xref:dotnet-analytics-sdk:hello-world:overview.adoc[Version 1.1]
* xref:dotnet-analytics-sdk:hello-world:overview.adoc[Version 1.0]

[.tile]
.Go SDK
* xref:go-analytics-sdk:hello-world:overview.adoc[Version 1.1]
* xref:go-analytics-sdk:hello-world:overview.adoc[Version 1.0]

[.tile]
.Java SDK
* xref:java-analytics-sdk:hello-world:overview.adoc[Version 1.1]
* xref:java-analytics-sdk:hello-world:overview.adoc[Version 1.0]

[.tile]
.Node.js SDK
* xref:nodejs-analytics-sdk:hello-world:overview.adoc[Version 1.1]
* xref:nodejs-analytics-sdk:hello-world:overview.adoc[Version 1.0]

[.tile]
.Python SDK
* xref:python-analytics-sdk:hello-world:overview.adoc[Version 1.1]
* xref:python-analytics-sdk:hello-world:overview.adoc[Version 1.0]


[.tiles.browse]
== Columnar SDKs for Capella Analytics
...
[.tile]
.Spark Connector
* xref:4.0@spark-connector::index.adoc[Version 4.0]
...
* Power BI Connector: xref:1.3@power-bi-connector:ROOT:index.adoc[1.3] | xref:1.2@power-bi-connector:ROOT:index.adoc[1.2] | xref:1.1@power-bi-connector:ROOT:index.adoc[1.1] | xref:1.0@power-bi-connector:ROOT:index.adoc[1.0]
* Tableau Connector: xref:2.0@tableau-connector:ROOT:index.adoc[2.0] | xref:1.2@tableau-connector:ROOT:index.adoc[1.2] xref:1.1@tableau-connector:ROOT:index.adoc[1.1] | xref:1.0@tableau-connector:ROOT:index.adoc[1.0]
