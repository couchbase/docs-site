...
Welcome to the Couchbase documentation!
...
Configure, deploy, and manage Couchbase
...
Develop an application on Couchbase Server
...
Develop applications on the edge with Couchbase Mobile
...
[.tile]
.xref:server:sdk:overview.doc[SDKs]
* xref:@c-sdk::start-using-sdk.adoc[C/C++]
...
* xref:scala-sdk::start-using-sdk.adoc[Scala]
