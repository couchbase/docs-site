...
[.content]
If you are an existing Couchbase user looking for information to upgrade to Couchbase Server 8.x and use collections and scopes, see xref:server:install:migrating-application-data.adoc[Upgrade and migrate your data to v8.x].
