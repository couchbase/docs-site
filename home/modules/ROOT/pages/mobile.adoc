...
App Services is the hosted version, part of the Capella family, and synchronizes your edge devices with Capella Operational. +
xref:cloud/mobile-guides/intro.adoc[Go to App Services Docs] +
