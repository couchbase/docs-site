...
Your pull request will be reviewed by a member of the docs team responsible for the area of documentation you are helping to improve.
...
Response will normally be within a couple of working days, but can be longer -- please bear with us, we really do appreciate contrybutions from the community, but occasionally writers have to juggle many demands.
