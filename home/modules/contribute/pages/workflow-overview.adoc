...
* [x] xref:repository-requirements.adoc[Review each repository's requirements].
* [x] xref:repository-requirements.adoc#dir-structure[Explore the component directory structure].
