...
| Date format | For best https://en.wikipedia.org/wiki/Date_format_by_country[international understanding] use https://en.wikipedia.org/wiki/ISO_8601[ISO 8601]. E.g. *1969-07-20*.
