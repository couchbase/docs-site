...
All bugs and enhancements for the Couchbase documentation are tracked using the https://jira.issues.couchbase.com/browse/DOC[DOC project issue board^].
...
https://jira.issues.couchbase.com/browse/DOC-2056[DOC-2056^] is an example of a well-written DOC bug which allowed the assigned writer to make the necessary changes quickly.
