...
Also note that a few of the repositories use custom branch names, see xref:repository-requirements.adoc#repo-special[Repositories that Require Special Handling] for more information.
