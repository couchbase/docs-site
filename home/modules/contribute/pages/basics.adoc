...
Documents that are saved in the _pages_ directory of a module must have a title.
...
Don't nest headings out of order.
...
----
include::{examplesdir}/inline-styles.adoc[]
----
...
----
include::{examplesdir}/ui-macros.adoc[]
----
...
----
include::{examplesdir}/lists.adoc[tag=check]
----
...
----
include::{examplesdir}/description-lists.adoc[tag=basic]
----
...
----
include::{examplesdir}/description-lists.adoc[tag=complex]
----
...
----
include::{examplesdir}/lists.adoc[tag=ordered]
----
...
----
include::{examplesdir}/lists.adoc[tag=unordered]
----
...
.Basic admonitions
----
include::{examplesdir}/admonitions.adoc[tag=basic]
----
...
.Complex admonition
----
include::{examplesdir}/admonitions.adoc[tag=complex]
----
...
----
include::{examplesdir}/tables.adoc[tag=two-col]
----
...
....
include::{examplesdir}/tables.adoc[tag=adoc]
....
...
----
include::{examplesdir}/tables.adoc[tag=spans]
----
...
There are many more AsciiDoc table attributes, options, and specifiers.
...
//* Page, block, and inline roles
//* Attributes and metadata

Also, you can find more AsciiDoc examples in the {url-pages}[Antora documentation].
