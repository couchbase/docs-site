...
See xref:repository-requirements.adoc#repo-urls[Repository Requirements and Organization] for the list of active repositories
...
See xref:repository-requirements.adoc#repo-special[Repositories that Require Special Handling] for more information or propose fixes and improvements using the btn:[Feedback?] button at the bottom of the page.
****
