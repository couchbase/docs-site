...
module.exports.register = function ({ playbook, config }) {
  ...
  this.once('redirectsProduced', async ({contentCatalog}) => {
    contentCatalog.addFile({
          contents: Buffer.from("PLACEHOLDER"), // this file will actually be replaced below
          src: {
            component: "home",
            version: "master",
            module: 'ROOT',
          ...
          out: {
            path: 'llms.txt' // override the path
          }
    })
  })
